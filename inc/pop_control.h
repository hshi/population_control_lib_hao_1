...
int deter_buf_send_number(int L_chunk, int send_number, const std::vector<int>& table_send);
int deter_buf_recv_number(const std::vector<int>& table_recv);
#endif
...
void pop_control(std::vector<T>& walker, const std::vector<int>& table)
{
    ...
    int buf_send_number=deter_buf_send_number(L_chunk, send_number, table_send);
    int buf_recv_number=deter_buf_recv_number(table_recv);
